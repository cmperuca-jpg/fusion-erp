...
const PERFIS_PADRAO = {
  ...
  Gerente: [
    ...
    "financeiro", "mensalidades", "caixa", "comercial", "comercial-painel",
    "avaliacoes", "treinos", "planos", "turmas", "relatorios"
  ],
  Recepcao: [
    "dashboard", "alunos", "matriculas", "matriculas-pendentes", "financeiro",
    "mensalidades", "caixa", "comercial", "comercial-painel", "checkin"
  ],
  Comercial: ["dashboard", "comercial", "comercial-painel", "matriculas-pendentes", "leads", "matricula-online"],
  Professor: ["professor-area", "professor-painel", "avaliacoes", "treinos", "aluno-treinos"],
