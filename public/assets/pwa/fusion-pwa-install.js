(() => {
  ...
  const APPS = {
    aluno: {
      enabled: path.includes("/pages/portal-aluno/") || path.includes("/pages/aluno-login/") || path.includes("/pages/treinos-v3-aluno/"),
      name: "Fusion Aluno",
      color: "#16a34a",
    ...
    professor: {
      enabled: path.includes("/pages/professor-area/") || path.includes("/pages/professor-painel/"),
