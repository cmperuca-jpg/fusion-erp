...
function filtrarAlunosDoProfessor(lista = []) {
  ...
  // O responsável técnico acessa todos os alunos, inclusive inativos
  // e sem vínculo direto com o professor logado.
  if (ehResponsavelTecnico(sessao)) return Array.isArray(lista) ? lista : [];
