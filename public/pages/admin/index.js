...
function permissoesPorPerfil(perfil) {
  const mapa = {
    Administrador: ["*"],
    Gerente: ["dashboard","alunos","professores","matriculas","matriculas-pendentes","financeiro","mensalidades","caixa","comercial","comercial-painel","avaliacoes","treinos","planos","turmas","relatorios"],
    Recepcao: ["dashboard","alunos","matriculas","matriculas-pendentes","financeiro","mensalidades","caixa","comercial-painel","checkin"],
    Comercial: ["dashboard","comercial","comercial-painel","matriculas-pendentes"],
    Professor: ["professor-area","avaliacoes","treinos","aluno-treinos"],
    Aluno: ["aluno-treinos","aluno-avaliacao","portal-aluno"]
  };
