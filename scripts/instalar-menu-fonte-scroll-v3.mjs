...
/* === Fusion ERP Menu Global v3: fonte, tamanho e scroll fixos === */
:root{
...
css = css.replace(/\/\* === Fusion ERP Menu Global v3:[\s\S]*?body \.fusion-sidebar \.fusion-sidebar-footer\{[\s\S]*?\}\s*/g, '');
if (!css.includes('Fusion ERP Menu Global v3')) css += cssPatch;
